module.exports = function (plop) {
	...
	plop.setHelper('componentCase', (text) => text.replace(/\s+/g, '-').toLowerCase());
	plop.setHelper('pascalCase', (text) => text.match(/[a-z]+/gi).map((word) => word.charAt(0).toUpperCase() + word.substr(1).toLowerCase()).join(''));
