(function (global, factory) {
	...
	var methods = {
	  checkboxChange : (ev)=>{
	   ...
	   //document.querySelector("fw-checkbox").setAttribute("checked",ev.checked)
	  }
	};
