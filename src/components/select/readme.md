...
| `multi`        | `multi`         | Set to true for multiselect mode                                          | `boolean`                          | `false`     |
...
| `selectedText` | `selected-text` | Set the selected text                                                     | `string`                           | `''`        |
...
| `value`        | --              | The value of the input. Similar to an input value                         | `any[]`                            | `[]`        |
