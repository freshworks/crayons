...
fw-textarea displays an input box on the user interface and enables assigning a multi-line text value to it. The size of the input box is based on the cols and rows attributes.
