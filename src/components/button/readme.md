...
| ---------- | ---------- | ---------------------------------------------------------------------- | -------------------------------------- | ----------- |
| `color`    | `color`    | The theme of the button, Values are : `primary`, `secondary`, `danger` | `"danger" \| "primary" \| "secondary"` | `'primary'` |
...
| `size`     | `size`     | The size of the button, Values are : `normal`, `mini`                  | `"mini" \| "normal"`                   | `'normal'`  |
