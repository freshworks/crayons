...
| `dataRegisterLibs` | `data-register-libs` | Identifier of the icon. The attribute’s value must be a valid JS Import Name of the svg in the named export from @freshworks/crayons-icon.                            | `any`     | `undefined` |
...
| `type`             | `type`               | Identifier of the icon. Type values 'registry' \| 'icon'.                                                                                                             | `string`  | `'icon'`    |
