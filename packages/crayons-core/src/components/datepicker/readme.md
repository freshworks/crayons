...
| `fwFormBlur`  | Triggered when the input loses focus. It can used with `fw-form`.             | `CustomEvent<any>` |
| `fwFormInput` | Triggered when the value is entered in the input. It can used with `fw-form`. | `CustomEvent<any>` |
