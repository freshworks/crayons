...
| `formatCreateLabel` | --               | Works only when 'isCreatable' is selected. Function to format the create label displayed as an option.                                                                                                                                    | `Function`                                            | `(value) => `Create ${value}`` |
...
| `validateNewOption` | --               | Works only when 'isCreatable' is selected. Function to validate the newly created value.                                                                                                                                                  | `Function`                                            | `undefined`                    |
