...
| `noDateText`    | `no-date-text`   | Text to be displayed when there is no data available in the select.                                                                                                                                                                       | `string`                                         | `'No Data available'`        |
...
| `search`        | --               | Filter function of signature (filterText : string, dataSource: Array<FwSelectOptions>) => Promise<Array<any>>. Where filter text is the text to filter the value in dataSource array.                                                     | `(text: any, dataSource: any) => Promise<any[]>` | `this.defaultSearchFunction` |
