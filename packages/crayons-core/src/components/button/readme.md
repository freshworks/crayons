...
<section>
  ...
  <fw-button size="icon"
    ><fw-icon name="agent" color="white" library="system" ></fw-icon>
  </fw-button>
  <fw-button size="icon" color="secondary"
    ><fw-icon name="phone" library="system" ></fw-icon>
  </fw-button>
</section>
<br />
...
<section>
  ...
  <fw-button show-caret-icon>
    <fw-icon name="calendar-time" slot="before-label" library="system" ></fw-icon>
    Select date
  </fw-button>
...
<section>
  ...
  <fw-button color="secondary">
    <fw-icon slot="before-label" name="delete" library="system" ></fw-icon>
    <span>Delete</span>
  </fw-button>
  <fw-button color="primary">
    <span>Copy</span>
    <fw-icon name="code" slot="after-label" library="system" ></fw-icon>
  </fw-button>
</section>
<br />
