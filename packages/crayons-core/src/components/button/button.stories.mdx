...
<Preview>
<Story name='IconText'>{() => `
    <fw-button><fw-icon slot="before-label" name="phone" color="white" ></fw-icon> Call</fw-button>
    <fw-button color="primary"><fw-icon slot="before-label" color="#fefefe" name="agent" ></fw-icon> Support</fw-button>
    <fw-button color="secondary"><fw-icon slot="before-label" name="delete" ></fw-icon> Delete</fw-button>
    <fw-button color="danger"><fw-icon slot="before-label" color="#fefefe" name="code" ></fw-icon> See Code</fw-button>`}
</Story>
</Preview>

### Caret with icon
<Preview>
<Story name='Caret with icon'>{() => `
