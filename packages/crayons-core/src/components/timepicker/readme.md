...
| `format`           | `format`            | Format in which time values are populated in the list box. If the value is hh:mm p, the time values are in the 12-hour format. If the value is hh:mm, the time values are in the 24-hr format. The default value will be set based on the locale time format. | `string`                                                                                                                                                             | `undefined` |
