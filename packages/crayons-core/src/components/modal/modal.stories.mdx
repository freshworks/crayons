...
export const Template_Default = () =>{
  return `<fw-button modal-trigger-id='welcome'> Open Modal </fw-button>
...
export const Template_Large_Modal = () =>{
  return `<fw-button modal-trigger-id='large'> Open Large Modal </fw-button>
...
export const Template_Custom_composition = () =>{
  return ` <fw-button modal-trigger-id='large'> Open custom composed modal </fw-button>
...
export const Template_Slider = () =>{
  return `  <fw-button modal-trigger-id='modal-slider'> Open slider </fw-button>
...
<Preview>
  <Story 
    ...
    play={ async ({ canvasElement }) => {
        setTimeout(()=>{
          const modal =  document.querySelector('fw-button');
          modal.shadowRoot.querySelector('button').click();
        },500);
    }}
    decorators={[
      (Story) => {
...
<Preview>
  ...
  >
    {Template_Custom_composition.bind({})}
  </Story>
</Preview>
