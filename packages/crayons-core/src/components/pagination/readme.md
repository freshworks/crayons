...
| `marginPagesDisplayed` | `margin-pages-displayed` | represents the number of pages to be shown on both the margins. Defaults to 1.                                                                                                                                                                                   | `number`               | `1`                    |
| `nextButtonLabel`      | `next-button-label`      | Aria Label to be used for next button.                                                                                                                                                                                                                           | `string`               | `''`                   |
| `page`                 | `page`                   | The current page number.                                                                                                                                                                                                                                         | `number`               | `1`                    |
| `pageRangeDisplayed`   | `page-range-displayed`   | represents the range of pages to be shown. Defaults to 4.                                                                                                                                                                                                        | `number`               | `4`                    |
