...
let Pill = class {
  ...
  render() {
    return (h("span", { class: this.pillClass }, this.hasIcon && (h("div", { class: 'pill-icon' }, h("slot", { name: 'icon' }))), h("slot", null)));
  }
