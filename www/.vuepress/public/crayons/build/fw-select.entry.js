...
import { b as hasSlot, r as renderHiddenField, h as handleKeyDown } from './index-9b8d850f.js';
...
let Select = class {
    ...
    if (this.changeEmittable()) {
      switch (ev.key) {
        ...
        case 'Backspace':
          ...
          else if (this.multiple && ((_a = this.selectInput) === null || _a === void 0 ? void 0 : _a.value) === '') {
            this.focusOnTagContainer();
          }
          break;
        case 'ArrowLeft':
  ...
  focusOnTagContainer() {
    ...
    if (Array.isArray(this.value) &&
      !this.selectedOptionsState[((_a = this.value) === null || _a === void 0 ? void 0 : _a.length) - 1].disabled) {
      this.tagArrowKeyCounter = ((_b = this.value) === null || _b === void 0 ? void 0 : _b.length) - 1;
      this.focusOnTag(this.tagArrowKeyCounter);
    }
  }
  focusOnTag(index) {
  ...
  render() {
    ...
    return (h(FieldControl, { inputId: this.name, label: this.label, labelId: `${this.label}-${this.name}`, state: this.state, hintTextId: `hint-${this.name}`, hintText: this.hintText, hasHintTextSlot: this.hasHintTextSlot, errorTextId: `error-${this.name}`, errorText: this.errorText, hasErrorTextSlot: this.hasErrorTextSlot, warningTextId: `warning-${this.name}`, warningText: this.warningText, hasWarningTextSlot: this.hasWarningTextSlot, required: this.required }, h("div", { "aria-disabled": this.disabled, class: {
      ...
      } }, h("fw-icon", { name: 'chevron-down', size: 8, library: 'system' }))))))), h("fw-list-options", Object.assign({ ref: (fwListOptions) => (this.fwListOptions = fwListOptions), id: `${this.hostId}-listbox`, role: 'listbox', "aria-labelledby": this.labelledBy || `${this.hostId}-label`, notFoundText: this.notFoundText, debounceTimer: this.debounceTimer, noDataText: this.noDataText, search: this.search, selectedOptions: this.selectedOptions, variant: this.optionsVariant, "filter-text": this.searchValue, options: this.dataSource, value: this.value, multiple: this.multiple, disabled: this.disabled, checkbox: this.checkbox, allowDeselect: this.allowDeselect, slot: 'popover-content' }, listAttributes)))))));
  }
