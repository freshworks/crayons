...
import { g as getFocusableChildren, h as handleKeyDown, a as hasSlot, r as renderHiddenField } from './index-9d2a65d7.js';
import { F as FieldControl } from './field-control-33f3464c.js';
import { T as TranslationController, i as i18n } from './Translation-aed16280.js';
...
let Datepicker = class {
  ...
  async getValue() {
    if (this.mode === 'range') {
      return {
        fromDate: (this.startDate &&
          format(parse(this.startDate, this.displayFormat, new Date(), {
            locale: this.langModule,
          }), this.displayFormat, {
            locale: this.langModule,
          })) ||
          undefined,
        toDate: (this.endDate &&
          format(parse(this.endDate, this.displayFormat, new Date(), {
            locale: this.langModule,
          }), this.displayFormat, {
            locale: this.langModule,
          })) ||
    ...
    return this.displayFormat
      ? (this.value &&
        format(parse(this.value, this.displayFormat, new Date(), {
          locale: this.langModule,
        }), this.displayFormat, {
          locale: this.langModule,
        })) ||
  ...
  render() {
    ...
    return (h(FieldControl, { inputId: this.name, label: this.label, labelId: `${this.label}-${this.name}`, state: this.state, hintTextId: `hint-${this.name}`, hintText: this.hintText, hasHintTextSlot: this.hasHintTextSlot, errorTextId: `error-${this.name}`, errorText: this.errorText, hasErrorTextSlot: this.hasErrorTextSlot, warningTextId: `warning-${this.name}`, warningText: this.warningText, hasWarningTextSlot: this.hasWarningTextSlot, required: this.required }, h("fw-popover", { "same-width": 'false', distance: '8', placement: 'bottom-start', fallbackPlacements: ['top-start'], "hide-on-tab": 'false', onFwHide: this.handlePopoverClose }, h("div", { role: 'combobox', "aria-controls": 'datepicker', "aria-expanded": this.showDatePicker, tabindex: '-1', onClick: () => (this.showDatePicker = true), onKeyUp: () => (this.showDatePicker = true), slot: 'popover-trigger', style: {
      ...
      } }))))), this.showSingleDatePicker() ? (h("div", { id: 'datepicker', class: 'datepicker', slot: 'popover-content' }, h("div", { class: 'mdp-container' }, h("div", { class: 'mdpc-head' }, h("div", { class: 'mdpch-container' }, h("span", { class: 'mdpchc-month' }, h("fw-select", { class: 'first single-month-selector', readonly: true, value: this.shortMonthNames[this.month], "same-width": 'false', variant: 'button', "options-placement": 'bottom-start', options: this.longMonthNames.map((month, i) => ({
