...
def uploadAndInvalidate(environment) {
  ...
  uploadAssetsToS3('docs-dist', "s3://${STATIC_ASSETS[environment].bucketName}/v2", 'us-east-1', true, false, 86400, STATIC_ASSETS[environment].profile)
  uploadAssetsToS3('storybook-dist', "s3://${STATIC_ASSETS[environment].bucketName}/v2/storybook", 'us-east-1', true, false, 86400, STATIC_ASSETS[environment].profile)
